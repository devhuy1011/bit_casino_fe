...
import { dayoptions, monthoptions, yearoptions, zipoptions } from 'const/value'

import Menu from 'components/Menu'
import { Image, Button, Input, Checkbox, Select } from 'antd'
  ...
  return (
    <S.Wrapper>
      <S.Title>
        ...
        <S.Form>
          <S.Account>
            <S.Description>Tên đăng nhập</S.Description>
          ...
          <S.Date>
            <S.Day>
              <S.Description>Ngày</S.Description>
              <Select defaultValue="" style={{ width: 100 }} options={dayoptions} />
            </S.Day>
            <S.Month>
              <S.Description>Tháng</S.Description>
              <Select defaultValue="" style={{ width: 100 }} options={monthoptions} />
            </S.Month>
            <S.Year>
              <S.Description>Năm</S.Description>
              <Select defaultValue="" style={{ width: 100 }} options={yearoptions} />
            </S.Year>
          </S.Date>
          <hr />
          <S.Country>
            <S.Zipcode>
              <S.Description>Mã quốc gia</S.Description>
              <Select defaultValue="VN (+84)" style={{ width: 100 }} options={zipoptions} />
            </S.Zipcode>
            <S.Phone>
              <S.Description>Số điện thoại(Không bắt buộc)</S.Description>
